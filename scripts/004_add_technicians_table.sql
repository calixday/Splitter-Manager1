...
ADD COLUMN IF NOT EXISTS technician_id TEXT REFERENCES public.technicians(id) ON DELETE SET NULL DEFAULT '1';

-- Set all existing locations to have ngaira as technician if not already set
